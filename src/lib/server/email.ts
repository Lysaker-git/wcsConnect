  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    <div style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      ...
      <div style="padding:32px;">
        <h2 style="margin:0 0 16px;color:#111827;font-size:22px;font-weight:700;">Registration received</h2>
        <p style="color:#374151;line-height:1.6;margin:0 0 16px;">Hi ${username},</p>
        <p style="color:#374151;line-height:1.6;margin:0 0 24px;">
          We've received your registration for <strong>${eventTitle}</strong>. Your spot is currently <strong>pending approval</strong> by the Event Director.
        </p>
        ...
        <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:20px;margin:0 0 28px;">
          ...
          <ol style="margin:0;padding-left:20px;color:#6b7280;font-size:13px;line-height:1.8;">
            <li>The Event Director reviews your registration</li>
            <li>You'll receive an email once you're approved</li>
            <li>You can then complete your payment through the DancePoint site</li>
          </ol>
        </div>

        <p style="color:#6b7280;font-size:13px;line-height:1.6;margin:0 0 28px;">
          You can view your registration status at any time by visiting your profile on DancePoint.
        </p>
      ...
      <div style="padding:24px 32px;border-top:1px solid #e5e7eb;text-align:center;">
        <p style="margin:0;font-size:12px;color:#9ca3af;">© DancePoint · dancepoint.no</p>
      </div>
...
export async function sendPasswordResetEmail({
  ...
  await sendEmail({
    to,
    subject: 'Reset your DancePoint password',
    html: `
<!DOCTYPE html>
<html>
<head>
  ...
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    <div style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
      ...
      <div style="padding:32px;">
        ...
        <p style="color:#374151;line-height:1.6;margin:16px 0 24px;">
          We received a request to reset the password for your DancePoint account.
          Click the button below to choose a new password.
        </p>

        <div style="text-align:center;margin:0 0 32px;">
          <a href="${resetLink}"
            style="display:inline-block;padding:14px 32px;background:#d97706;color:#ffffff;text-decoration:none;border-radius:8px;font-weight:700;font-size:16px;">
            Reset password
          </a>
        </div>
